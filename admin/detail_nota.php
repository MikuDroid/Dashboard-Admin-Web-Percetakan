        ...
        <div class="container border border-primary" style="margin-top: 75px; margin-bottom: 75px;">
            ...
            <table class="table" style="border: none">
                ...
                <tbody>
                    ...
                    $total = $nota['harga_barang']*$nota['banyak_barang'];
                    $harga_total += $total;
                    $jumlah_total += $nota['banyak_barang'];
                    $i++;
                    ...
                    <tr>
                        ...
                        <td class="text-center no-line"><?= number_format($nota['harga_barang']) ?></td>
                        <td class="text-center no-line"><?= $nota['banyak_barang'] ?></td>
