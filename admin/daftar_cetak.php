                                        ...
                                        <tbody>
                                           ...
                                           <?php foreach ($products as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                	<form action="set_ambil.php" method="post">
                                                	<input type="hidden" id="id_cetak" name="id_cetak" value="<?= $data['id_cetak']?>" >
													<?php if ($data['sudah_ambil'] == 1) { ?>
														<input type="checkbox" id="disable" name="disable" checked onChange="this.form.submit()">
													<?php } else { ?>
														<input type="checkbox" id="enable" name="enable" onChange="this.form.submit()">
													<?php } ?>
													</form>
												</td>
