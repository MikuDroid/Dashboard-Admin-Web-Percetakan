                                           ...
                                           <?php foreach ($products as $data) : ?>
                                            <tr>
                                                ...
                                                <form method="post" action="nota.php">
                                                    ...
                                                    <a href="detail_nota.php?id_pelanggan=<?= $data['id_pelanggan'] ?>" name="detail" class="btn btn-success btn-sm ">Detail</a>
                                                </form>
                                                </td>
                                                <td><a href="hapus.php?id_pelanggan=<?= $data['id_pelanggan']; ?>" class="btn btn-danger btn-sm">Hapus</a></td>
                                            </tr>
                                            <?php $i++; ?>
                                            <?php endforeach; ?>
                                        </tbody>
